...
public class Mahanyasa extends AppCompatActivity {
int n = 0;
...
private MediaPlayer mp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mantr_v.setTextSize(15);
//   Code starts  Opening Spinner Item to Array

// TextView Arrays are here
       String[] shivasankalpa = getResources().getStringArray(R.array.shivasankalpa);


        String[][] texts = new String[][]{shivasankalpa};

//        counter.setText(String.valueOf(udakashanti.length));
        String[] shivasankalpa_index = new String[shivasankalpa.length];
        for(int i=0; i<shivasankalpa.length; i++){
            shivasankalpa_index[i]=shivasankalpa[i].split(" ")[0]+" "+shivasankalpa[i].split(" ")[1];
        }
...
//   Spinner Text Are here (main Spinner And sub Spinner)
        ...
        int[] spinner_main = new int[]{R.array.mahanyasa_index};
        int[] spinner_sub = new int[]{R.array.shivasankalpa};
...
// Main Spinner on Click Listner
        smain.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(i==0){
                    ArrayAdapter<CharSequence> udak_spin = new ArrayAdapter<CharSequence>(getApplicationContext(),R.layout.support_simple_spinner_dropdown_item,shivasankalpa_index);
            ...
            public void onClick(View v) {
                if(checkpermissions()==true){
                    ...
                    try {
                        mic.prepare();
                        mic.start();
                        Toast.makeText(Mahanyasa.this, "Recording Started", Toast.LENGTH_SHORT).show();
                    ...
                    ActivityCompat.requestPermissions(Mahanyasa.this,new String[]{Manifest.permission.RECORD_AUDIO,Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                }
        ...
        stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mic.stop();
                mic.release();
                Toast.makeText(Mahanyasa.this, "Stopped", Toast.LENGTH_SHORT).show();
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    mp.prepare();
                    mp.start();
                    Toast.makeText(Mahanyasa.this, "om", Toast.LENGTH_SHORT).show();
//                    mp.setLooping(true);
                } catch (IOException e) {
                    e.printStackTrace();
                }
