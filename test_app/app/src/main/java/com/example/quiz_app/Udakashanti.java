...
public class Udakashanti extends AppCompatActivity {
int n = 0;
...
//      Changing Sub Spinner Option by Array
                    ArrayAdapter<CharSequence> spins2 = ArrayAdapter.createFromResource(Udakashanti.this, spinner_sub[i], android.R.layout.simple_spinner_dropdown_item);
            ...
            public void onClick(View v) {
                if(checkpermissions()==true){
                    ...
                    try {
                        mic.prepare();
                        mic.start();
                        Toast.makeText(Udakashanti.this, "Recording Started", Toast.LENGTH_SHORT).show();
                    ...
                    ActivityCompat.requestPermissions(Udakashanti.this,new String[]{Manifest.permission.RECORD_AUDIO,Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                }
        ...
        stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mic.stop();
                mic.release();
                Toast.makeText(Udakashanti.this, "Stopped", Toast.LENGTH_SHORT).show();
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    mp.prepare();
                    mp.start();
                    Toast.makeText(Udakashanti.this, "om", Toast.LENGTH_SHORT).show();
//                    mp.setLooping(true);
                } catch (IOException e) {
                    e.printStackTrace();
                }
